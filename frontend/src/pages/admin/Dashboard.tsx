...
import { Calendar, Users, DollarSign, Clock, TrendingUp, Scissors, AlertCircle } from 'lucide-react';
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6 flex items-center gap-4">
          ...
          <div>
            <p className="text-red-400 font-semibold">Não foi possível carregar o dashboard</p>
            <p className="text-gray-400 text-sm mt-1">
              O backend não está respondendo ou o banco de dados ainda não foi configurado.
              Verifique se o backend está rodando e se o Supabase está configurado no <code className="bg-gray-700 px-1 rounded text-amber-400">backend/.env</code>.
            </p>
          </div>
        </div>
      </div>
